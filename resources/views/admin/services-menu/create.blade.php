    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="margin-bottom: 20px;">Create Service Menu</h4>
                        <form action="{{ route('admin.services-menu.store') }}" method="POST">
                            @csrf
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="number" step="0.01" value="{{ old('price') }}" name="price" id="example-text-input">
                                    @error('price')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="number" step="1" value="{{ old('time') }}" name="time" id="example-text-input">
                                    @error('time')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="wash_package_id">
                                        ...
                                        <option value="{{ $washPackage->id }}" {{ old('wash_package_id') == $washPackage->id ? 'selected' : '' }}>{{ $washPackage->name }} (${{ $washPackage->price }})
                                        </option>
                                        @endforeach
                                    </select>
