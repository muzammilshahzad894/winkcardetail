...
;(function($,doc,win) 
{
	...
	var booking=function(object,option)
	{
		...
		this.build=function() 
		{
			...
			$(document).on('click', '.template-component-booking-package-list>li>.template-component-button-box>a[href="#"]', function(e) {
				e.preventDefault();
				$self.packageSelect($(this).parents('li:first'));
				$self.serviceSet();
				$self.calculate();
			...
			$(document).on('click', '.template-component-booking-service-list>li>.template-component-button-box>a', function(e) {
				e.preventDefault();
				$self.serviceSelect($(this).parents('li:first'));
				$self.calculate();
			});
