!(function (a) {
    ...
    // function r(e) {
    //     if (
    //         a("#light-mode-switch").prop("checked") &&
    //         "light-mode-switch" === e
    //     ) {
    ...
    //         a("#app-style").attr("href", "admin-assets/css/app.min.css");
    //         sessionStorage.setItem("is_visited", "light-mode-switch");
    //     } else if (
    //         a("#dark-mode-switch").prop("checked") &&
    //         "dark-mode-switch" === e
    //     ) {
    //         a("html").removeAttr("dir");
    ...
    //     } else if (
    //         a("#rtl-mode-switch").prop("checked") &&
    //         "rtl-mode-switch" === e
    //     ) {
    //         a("#light-mode-switch").prop("checked", !1);
    //         a("#dark-mode-switch").prop("checked", !1);
    ...
    //         );
    //         a("#app-style").attr("href", "admin-assets/css/app-rtl.min.css");
    //         a("html").attr("dir", "rtl");
    //         a("body").attr("data-layout-mode", "light");
    //         sessionStorage.setItem("is_visited", "rtl-mode-switch");
    //     } else if (
    //         a("#dark-rtl-mode-switch").prop("checked") &&
